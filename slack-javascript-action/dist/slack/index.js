...
const slackMessage = () => __awaiter(void 0, void 0, void 0, function* () {
    const channel = (0, core_1.getInput)("channel");
    const blocks = (0, core_1.getInput)("blocks");
    const text = (0, core_1.getInput)("text");
    const updateMessageId = (0, core_1.getInput)("update-message-id");
    const threadMessageId = (0, core_1.getInput)("thread-message-id");
    let message;
    if (updateMessageId) {
        message = yield (0, slack_client_1.updateMessage)(channel, updateMessageId, blocks, text);
    }
    else {
        message = yield (0, slack_client_1.sendMessage)(channel, blocks, text, threadMessageId);
    }
    if (message) {
        (0, core_1.setOutput)("message_id", message.ts);
    }
    return message;
});
exports.slackMessage = slackMessage;
(0, exports.slackMessage)().then(console.log).catch(console.error);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(6564);
